...
const WaitlistBanner: React.FC = ({ onOpenForm }) => {
  return (
    <div className="w-[95%] sm:w-4/5 lg:w-4/5 lg:max-w-5xl xl:w-6xl rounded-xl bg-white py-20 lg:py-20 mt-12 sm:mt-10 mb-12 sm:mb-20 mx-auto text-center flex flex-col items-center justify-between left-0 relative overflow-hidden shadow-lg ">
        ...
        />
        <h2 className="text-xl md:text-3xl lg:text-4xl xl:text-5xl font-heading font-bold mb-4 px-4 sm:px-0 sm:mr-4 md:mb-0 sm:whitespace-nowrap">
            Start managing your project <br/> 
            with the <span className="text-brand-primary font-bold">right platform</span>.
        </h2>

        <p className="mt-2 mb-4 text-gray-600 text-[12px] px-4 sm:px-0 sm:text-md md:text-md lg:text-lg xl:text-xl font-heading">
