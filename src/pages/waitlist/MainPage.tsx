...
import { AssignmentTurnedInOutlined, PersonOutlineRounded, PeopleAltOutlined, SettingsOutlined } from '@mui/icons-material';
...
// Content Arrays
const features = [
    { title: "Task Tracker", description: "Assign, prioritize, and monitor progress in real time without losing sight of the bigger picture.", image: Feature1 },
    { title: "RFI Manager", description: "No more email chains or lost requests. Manage every RFI in one organized system.", image: Feature2 },
    { title: "Design Change", description: "Turn feedback into actionable updates without breaking workflow.", image: Feature3 },
    { title: "Drawing Management", description: "Keep your team aligned with live drawing versions, smart organization, and instant access.", image: Feature4 },
]

const benefits = [
    { title: "Built for Design Teams", description: "Mirrors the real process of design - how your team thinks, plans, and delivers.", icon: <PeopleAltOutlined className="w-14 h-14 p-2"/> },
    { title: "Connected Design Threads", description: "Tasks, RFIs, and design changes interlink with each other and drawings - keeping every decision traceable.", icon: <img src={Drawing} alt="Drawing Icon" className="w-12 h-12 p-2"/> },
    { title: "Single Source of Truth", description: "Mirrors the real process of design - how your team thinks, plans, and delivers.", icon: <AssignmentTurnedInOutlined className="w-14 h-14 p-2"/> },
    { title: "Design Change Control", description: "Track, update, and approve revisions within the platform - transparent, traceable, and accountable.", icon: <img src={DesignChange} alt="Drawing Icon" className="w-14 h-14 p-2"/> },
    { title: "Aligned Consultants", description: "Architects, engineers, and designers collaborate through shared yet discipline-specific dashboard  ", icon: <PersonOutlineRounded className="w-14 h-14 p-2"/> },
    { title: "Agile, Not Messy", description: "Iterate quickly without losing clarity - built for the fast, feedback-driven design process.", icon: <SettingsOutlined className="w-14 h-14 p-2"/> },
]
    ...
    return (
        <div className="min-h-screen flex flex-col relative m-0 overflow-x-clip">
            ...
            <main id="waitlist" className="mx-auto w-full sm:w-[90%] md:w-[80%] lg:w-[70%] h-[65vh] sm:h-[70vh] md:h-[80vh] lg:h-[90vh] flex flex-col items-center justify-center text-center z-10">
                ...
                {/* Email Form */}
                <form className="px-10 sm:px-0 mt-5 sm:mt-20 sm:w-full lg:w-5xl xl:w-6xl space-y-4 " onSubmit={handleSubmit}>
            ...
            {/* Features Section */}
            <div className="container mx-auto flex flex-col text-center items-center justify-center p-4 mb-36" id='features'>
                ...
                Just the{" "}<span className="text-brand-primary">Right Tools</span>,{" "}<br/>
                in One Place
                </h1>
                </FadeInSection>

                <div id="features" className="flex flex-col items-center justify-center sm:grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 font-heading">
                    ...
                    >
                        <div className="group w-[80vw] sm:max-w-md 2xl:min-w-[550px] lg:max-w-fit my-2 mx-4 bg-white rounded-2xl shadow-lg overflow-hidden p-4 hover:shadow-2xl hover:scale-105 transform transition-all duration-300 ease-in-out text-left flex flex-col">
                            <div className="max-w-lg h-[25vh] sm:h-[30vh] mb-3 bg-brand-whiteback rounded-2xl shadow-inner p-2 group-hover:bg-gray-100 transition-all duration-300 ease-in-out">
                                <img src={feature.image} alt="Feature Graphic" className="w-full h-full object-contain group-hover:scale-118 transition-all duration-300 ease-in-out" />
                            </div>
                            <div className="mt-auto ml-2">
                                <h2 className="text-lg sm:text-2xl font-bold mb-2">{feature.title}</h2>
            ...
            {/* Benefits Section */}
            <div className="container mx-auto flex flex-col text-center items-center justify-center p-4 mb-20" id='benefits'>
                ...
                <FadeInSection>
                    ...
                    Built with{" "}<span className="text-brand-primary">Design</span>,{" "}<br/>
                    at its Core
                    </h1>
                </FadeInSection>
                        ...
                        {benefits.map((benefit, i) => (
                            <PopInItem key={i} index={i}>
                                <div className="group w-3/4 sm:max-w-md lg:w-xs xl:w-[370px] h-full mx-auto lg:mx-2 bg-white rounded-2xl shadow-lg overflow-hidden p-4 hover:shadow-2xl hover:scale-105 transform transition-all duration-300 ease-in-out text-left flex flex-col">
                                    ...
                                    <h2 className="text-md sm:text-xl font-bold mb-2">{benefit.title}</h2>
            ...
            <div className="container mx-auto flex flex-col items-center justify-center text-center px-4">
                ...
                Hear What {" "}<span className="text-brand-primary">Design Professionals</span>{" "}<br/>
